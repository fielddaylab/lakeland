  ...
  keycatch =
  {
    ...
    key_down:function(evt)
    {
      ...
      if(!debug)
      {
        ...
        if(keycatch.secretprogress == secret.length) { debug = 1; gg.shop.money_btn.active = 1; gg.b.own_tiles(gg.b.tiles_t(floor(gg.b.bounds_tx+gg.b.bounds_tw/2),floor(gg.b.bounds_ty+gg.b.bounds_th/2)), 2); }
      }
    },
    key:function(evt)
    {
